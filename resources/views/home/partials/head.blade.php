<head>
    ...
    <link rel="stylesheet" href="{{asset('vendor/business')}}/assets/vendor/icon-awesome/css/font-awesome.min.css">
    <link rel="stylesheet" href="{{asset('vendor/business')}}/assets/vendor/icon-line/css/simple-line-icons.css">
    <link rel="stylesheet" href="{{asset('vendor/business')}}/assets/vendor/icon-hs/style.css">
    <link rel="stylesheet" href="{{asset('vendor/business')}}/assets/vendor/hamburgers/hamburgers.min.css">
